            ...
            <section class="col-12">
                <section class="main-body-container">
                    ...
                    <section class="d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
                        <a href="{{ route('admin.content.category.create') }}" class="btn btn-primary btn-sm">ایجاد دسته
                            بندی</a>
                    </section>
                                            ...
                                            <td>
                                                <label>
                                                    @if ($postCategory->status === 1)
                                                        <span class="badge bg-success text-white font-weight-bold rounded-4">فعال</span>
                                                    @endif
                                                    @if ($postCategory->status === 0)
                                                        <span class="badge bg-danger text-white font-weight-bold rounded-4">غیر فعال</span>
                                                    @endif
                                                </label>
                                            </td>
