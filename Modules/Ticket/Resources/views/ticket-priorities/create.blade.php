                ...
                <section class="main-body-container">
                    ...
                    <section class="card border-0 rounded-4">
                        <section class="card-body">
                            <form id="form" action="{{ route('admin.ticket-priorities.store') }}" method="POST">
                                @csrf
                                <section class="row">
...
@section('script')
    {!! JsValidator::formRequest('Modules\Ticket\Http\Requests\TicketPriorities\TicketPrioritiesStore') !!}
    <script>
