                                            ...
                                            <td class="align-middle text-center text-sm">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu p-3">
                                                        <a href="{{ route('admin.content.post-comment.show', $comment->id) }}"
                                                            class="btn fw-bold btn-info btn-sm text-center my-1 rounded-4">نمایش</a>
                                                            
                                                        @if ($comment->approved == 1)
                                                            <a href="{{ route('admin.content.comment.post-comment.approved', $comment->id) }} "class="btn btn-warning btn-sm"
                                                                type="submit"><i class="fa fa-clock"></i> عدم تایید</a>
                                                        @else
                                                            <a href="{{ route('admin.content.comment.post-comment.approved', $comment->id) }}"
