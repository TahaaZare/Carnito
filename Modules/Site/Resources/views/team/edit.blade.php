            ...
            <div class="container">
                ...
                <form action="{{ route('admin.team.update', $team->id) }}" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="form-group row">
                        <div class="row">
                            <div class="col-lg-12 d-flex justify-content-center col-sm-12">
                                <div class="mb-4  justify-center">
                                    @if ($team->image != null)
                                        <img src="{{ asset($team->image) }}" alt="avatar" width="100" height="100"
                                            class="rounded-circle shadow" class="mt-3">
                                    @else
                                        <p class="text-center lead alert alert-warning fw-bold">
                                            کاربر تصویری ندارد !
                                        </p>
                                    @endif
                                </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="first_name"
                                        value="{{ old('first_name', $team->first_name) }}" placeholder=" نام عضو جدید"
                                        class="form-control" />
                                    @error('first_name')
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="last_name" value="{{ old('last_name', $team->last_name) }}"
                                        placeholder=" نام خوانوادگی عضو جدید" class="form-control" />
                                    @error('last_name')
                                        <div class="alert alert-warning text-center rounded-6 my-4">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="team_role" value="{{ old('team_role', $team->team_role) }}"
                                        placeholder=" نام خوانوادگی عضو جدید" class="form-control" />
                                    @error('team_role')
                                        <div class="alert alert-warning text-center rounded-6 my-4">
                                            {{ $message }}
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="telegram_link"
                                        value="{{ old('telegram_link', $team->telegram_link) }}" placeholder="لینک تلگرام"
                                        class="form-control" />
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-sm-6">
                                ...
                                <div class="form-group mb-4">
                                    <select name="status" id="" class="form-control" id="status">
                                        ...
                                        <option @if (old('status', $team->status) == 0) selected @endif value="0">غیرفعال
                                        </option>
                                        <option @if (old('status', $team->status) == 1) selected @endif value="1">فعال
                                        </option>
                                    </select>
                                    @error('status')
                                        <div class="alert alert-warning text-center rounded-6 my-4">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="form-group mb-4">
                                    <textarea name="bio" id="bio" cols="6" rows="6">{{old('bio',$team->bio)}}</textarea>
                                    @error('bio')
                                        <div class="alert alert-warning text-center rounded-6 my-4">
                                            {{ $message }}
                                        </div>
